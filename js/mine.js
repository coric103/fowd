...
const app = document.body; // Select the entire body element

// Get the current theme preference from localStorage (optional)
let currentTheme = localStorage.getItem("theme") || "light-theme"; // Default to light theme
